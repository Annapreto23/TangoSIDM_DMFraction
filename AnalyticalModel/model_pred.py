...
class Predictions:
    ...
    def plot_predictions(self, plot_errors = False):
        ...
        g.ax_joint.plot(np.linspace(0, 30, 100), np.linspace(0, 30, 100), linestyle='--', label='x = y', linewidth=0.5)
        ...
        g.fig.suptitle("Reference SigmaVel30 with c from the simulation", fontsize=15)
        g.ax_joint.legend()
